...
if __name__ == "__main__":
    ...
    API_Key = "d75256d5-2c38-4cf4-86d1-988674c05e95"
    API_Secret = "cfdb65ba-4334-4153-a0eb-d88612f3d9e57c502bd6-f7ec-40b2-8376-7d6228e31c06"
    X_Org_ID = "fe0da4de-145b-4846-855b-0b33d0c69c63"
    ...
    options.org = X_Org_ID
    options.key = API_Key
    options.secret = API_Secret
    options.path = "/main/api/v2/mining/rigs/stats/unpaid"

    private_api = private_api(options.base, options.org, options.key, options.secret)

    params = "afterTimestamp=" + str(int(1000 * datetime.timestamp(  datetime.fromisoformat('2021-09-23 21:25:00')))) + "&beforeTimestamp=" + str(int(1000 * datetime.timestamp(datetime.fromisoformat('2021-09-23 22:00:00'))))
